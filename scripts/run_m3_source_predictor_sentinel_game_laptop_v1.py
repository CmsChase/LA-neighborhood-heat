"""Run the migrated predictor queue with four Sentinel asset threads."""
...
def main() -> None:
    ...
    if args.write_authorization:
        ...
        mode, payload = "start", execute_game_laptop_worker(args.project_root, phase=args.phase)
    else:
