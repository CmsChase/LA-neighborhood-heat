...
| Cross-city continuation | `audit_multicity_plan.py`, `stage_multicity_geography.py`, `build_portable_predictor_components.py`, `build_portable_sentinel_features.py`, `import_portable_sentinel_results.py`, `audit_multicity_predictor_readiness.py` |
