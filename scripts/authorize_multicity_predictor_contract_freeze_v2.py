"""Create or authenticate the narrow multicity planning transition v11."""
...
from la_heat.multicity.plan_predictor_contract_transition_v11 import (
    authorize_multicity_predictor_contract_freeze_v2,
)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--check-only",
        action="store_true",
        help="Authenticate the existing canonical v11 planning record.",
    )
    return parser
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    payload = authorize_multicity_predictor_contract_freeze_v2(
        ...
        json.dumps(
            {
                ...
                "contract_freeze_v2_authorized": payload["authorized_now"][
