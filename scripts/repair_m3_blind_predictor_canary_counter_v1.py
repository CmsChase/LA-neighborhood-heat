"""Authorize, check, or apply the blind canary provenance-counter repair."""
...
from la_heat.multicity.m3_blind_predictor_canary_counter_repair_v1 import (
...
def main() -> None:
    ...
    if args.create_authorization:
        ...
        payload = repair(args.project_root)
    print(payload)
