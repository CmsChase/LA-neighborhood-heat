"""CLI for authorized blind-city Daymet acquisition."""
...
from la_heat.multicity.m3_blind_predictor_daymet_acquisition_v1 import (
...
def main() -> None:
    ...
    if args.preview_authorization:
        ...
        payload = run_acquisition(args.project_root)
    else:
