"""Preview, create, or authenticate the combined blind-target authorization."""
...
from la_heat.multicity.m3_blind_target_v1 import (
        ...
        json.dumps(
            {
                "mode": mode,
                "state": payload["state"],
                "dates": payload["eligible_date_count"],
