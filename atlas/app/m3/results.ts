export const M3_BLIND_RESULT = {
  ...
  earlierTransfer: {
    ...
    cityDates: 28,
    spatialBlocks: 180,
    relativeMaeImprovementPercent: 28.9161,
    bootstrapLowerPercent: 14.1055,
    bootstrapUpperPercent: 43.5138,
  ...
  diagnosis: {
    denverMeanBiasC: 13.2,
    denverAnomalyMaeC: 1.03,
    denverElevationM: 1630,
    maximumTrainingCityElevationM: 371,
    denverElevationContributionC: 12.94,
    sourceB1MaeC: 3.6578,
    bestAbsoluteVariantMaeC: 4.5796,
  },
  relative: {
    source: {
      cityDates: 132,
      ...
      b1MaeC: 1.6965,
      m3MaeC: 1.3606,
      improvementPercent: 19.8,
      bootstrapLowerC: 0.0886,
      bootstrapUpperC: 0.5828,
    },
    openedStress: {
      cityDates: 66,
      rows: 9502,
      b1MaeC: 1.4007,
      m3MaeC: 0.9976,
      improvementPercent: 28.8,
      bootstrapLowerC: 0.1835,
      bootstrapUpperC: 0.7355,
    },
    yearStability: {
      folds: 18,
      b1MaeC: 1.6008,
      m3MaeC: 1.0241,
      improvementPercent: 36.0,
      bootstrapLowerC: 0.1832,
      bootstrapUpperC: 0.8616,
    },
    fixedModel: {
      trainingRows: 96061,
      cityDates: 132,
      featureCount: 23,
      predictionKeys: 253632,
    },
  },
  cities: [
    {
